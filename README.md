...
![](media/image1.png){width="0.26458333333333334in"
...
4.  The Blueprint editor-canvas should appear as follows:
    ...
    ![](media/image2.tiff){width="5.764583333333333in"
...
10. To the Right of the Blueprint canvas there are set of fields
    ...
    b.  Under the **PROVIDERS** section, set the **PROVIDER** field by
        ...
        ![](media/image5.tiff){width="3.175845363079615in"
    ...
    e.  Create a credential by clicking on the dropdown menu under
        **CREDENTIAL**
        ...
        ![](media/image6.tiff){width="2.5145833333333334in"
...
10. Click the LAYERS + sign to expand (if needed). Select or click on
    ...
    ![](media/image10.tiff){width="4.9804800962379705in"
...
> ![](media/image11.png){width="1.7158650481189852in"
...
> ![](media/image12.tiff){width="2.423759842519685in"
...
10. Add another Task by clicking the ‘Add Task’ button in the
    ...
    ![](media/image13.tiff){width="2.479889545056868in"
...
> ![](media/image12.tiff){width="2.5145833333333334in"
...
8.  Add a 2nd task by clicking the ‘Add Task’ button in the
    ...
    ![](media/image14.tiff){width="2.597916666666667in"
...
9.  Add a 3rd task by clicking the ‘Add Task’ button in the
    ...
    ![](media/image15.tiff){width="2.528994969378828in"
...
> ![](media/image16.tiff){width="3.0145833333333334in"
...
> ![](media/image17.tiff){width="5.9463003062117235in"
...
12. If the Blueprint was successfully validated, click the **Play**
    ...
    **IN-PROGRESS**
    ...
    ![](media/image23.tiff){width="4.847916666666666in"
...
![](media/image24.tiff){width="4.903784995625546in"
...
10. Verify the deployment within Prism Element by navigating to the VM
    ...
    ![](media/image29.tiff){width="5.731081583552056in"
...
11. Verify the App Server is running by opening a browser (Chrome
    ...
    ![](media/image30.tiff){width="5.847916666666666in"
